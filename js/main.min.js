...
/*!*************************************************!*\
  ...
  \*************************************************/
/*! exports provided: initSeasonsTabs */function(e,t,s){"use strict";s.r(t),s.d(t,"initSeasonsTabs",(function(){return i}));var n=document.querySelectorAll(".season-item"),a=document.querySelector(".buttons-list"),r=a.querySelectorAll(".buttons-list__button"),i=function(){a.classList.remove("visually-hidden"),Array.from(n).forEach((function(e){e.style.marginBottom="0",e.querySelector(".season-item__title").classList.add("visually-hidden")})),Array.from(n).slice(1).forEach((function(e){e.classList.add("season-item--hidden")}));r.forEach((function(e){e.addEventListener("click",(function(){var t=function(e){return Array.from(n).find((function(t){return t.dataset.period===e.dataset.period}))}(e);n.forEach((function(e){return e.classList.add("season-item--hidden")})),r.forEach((function(e){return e.classList.remove("buttons-list__button--current")})),t.classList.remove("season-item--hidden"),e.classList.add("buttons-list__button--current")}))}))}},"./js/modules/staff-swiper/staff-swiper.js":
/*!*************************************************!*\
